document.addEventListener('DOMContentLoaded', function() {
    ...
    function checkAvailability() {
        ...
        if (sourceId && destId && departureTime) {
            ...
            fetch(`/api/check_availability?source_id=${sourceId}&dest_id=${destId}&departure_time=${departureTime}&aircraft_id=${aircraftId}`)
    ...
    function renderCrewList(crewList, container, requiredCount, type) {
        // Sort: Available first
        crewList.sort((a, b) => (a.is_available === b.is_available) ? 0 : a.is_available ? -1 : 1);
